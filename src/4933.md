...
2.3.  Individual and Organizational Names
   ...
   organizational names MAY be provided in both UTF-8 [RFC3629] and a
...
2.4.3.  Country
   ...
   identifiers specified in [ISO.3166.1997].
...
2.6.  Email Addresses
   ...
   Email address syntax is defined in [RFC0822].  This mapping does not
...
RFC 4933                  EPP Contact Mapping                   May 2007
   ...
   identifies the contact namespace.  The <contact:panData> element
   contains the following child elements:
