...
RFC:
:   [9189](https://www.rfc-editor.org/rfc/rfc9189){.eref}
...
# GOST Cipher Suites for Transport Layer Security (TLS) Protocol Version 1.2 {#title}
...
for the Transport Layer Security (TLS) protocol version 1.2 to support
...
GOST algorithms. This document does not imply IETF endorsement of the
cipher suites, signature algorithms, supported groups, and certificate
...
<https://www.rfc-editor.org/info/rfc9189>.[¶](#section-boilerplate.1-3){.pilcrow}
:::
:::
...
-   ::: {#section-toc.1-1.4}
    [4](#section-4){.xref}.  [Cipher Suite
    Definitions](#name-cipher-suite-definitions){.xref}

    -   ::: {#section-toc.1-1.4.2.1}
        [4.1](#section-4.1){.xref}.  [Record Payload
        Protection](#name-record-payload-protection){.xref}

        -   ::: {#section-toc.1-1.4.2.1.2.1}
            [4.1.1](#section-4.1.1){.xref}.  [CTR_OMAC](#name-ctr_omac){.xref}
            :::

        -   ::: {#section-toc.1-1.4.2.1.2.2}
            [4.1.2](#section-4.1.2){.xref}.  [CNT_IMIT](#name-cnt_imit){.xref}
            :::
        :::

    -   ::: {#section-toc.1-1.4.2.2}
        [4.2](#section-4.2){.xref}.  [Key Exchange and
        Authentication](#name-key-exchange-and-authentica){.xref}

        -   ::: {#section-toc.1-1.4.2.2.2.1}
            [4.2.1](#section-4.2.1){.xref}.  [Hello
            Messages](#name-hello-messages){.xref}
            :::

        -   ::: {#section-toc.1-1.4.2.2.2.2}
            [4.2.2](#section-4.2.2){.xref}.  [Server
            Certificate](#name-server-certificate){.xref}
            :::

        -   ::: {#section-toc.1-1.4.2.2.2.3}
            [4.2.3](#section-4.2.3){.xref}.  [CertificateRequest](#name-certificaterequest){.xref}
            :::

        -   ::: {#section-toc.1-1.4.2.2.2.4}
            [4.2.4](#section-4.2.4){.xref}.  [ClientKeyExchange](#name-clientkeyexchange){.xref}

            -   ::: {#section-toc.1-1.4.2.2.2.4.2.1}
                [4.2.4.1](#section-4.2.4.1){.xref}.  [CTR_OMAC](#name-ctr_omac-2){.xref}
                :::

            -   ::: {#section-toc.1-1.4.2.2.2.4.2.2}
                [4.2.4.2](#section-4.2.4.2){.xref}.  [CNT_IMIT](#name-cnt_imit-2){.xref}
                :::
            :::

        -   ::: {#section-toc.1-1.4.2.2.2.5}
            [4.2.5](#section-4.2.5){.xref}.  [CertificateVerify](#name-certificateverify){.xref}
            :::

        -   ::: {#section-toc.1-1.4.2.2.2.6}
            [4.2.6](#section-4.2.6){.xref}.  [Finished](#name-finished){.xref}
            :::
        :::

    -   ::: {#section-toc.1-1.4.2.3}
        [4.3](#section-4.3){.xref}.  [Cryptographic
        Algorithms](#name-cryptographic-algorithms){.xref}

        -   ::: {#section-toc.1-1.4.2.3.2.1}
            [4.3.1](#section-4.3.1){.xref}.  [Block
            Cipher](#name-block-cipher){.xref}
            :::

        -   ::: {#section-toc.1-1.4.2.3.2.2}
            [4.3.2](#section-4.3.2){.xref}.  [MAC
            Algorithm](#name-mac-algorithm){.xref}
            :::

        -   ::: {#section-toc.1-1.4.2.3.2.3}
            [4.3.3](#section-4.3.3){.xref}.  [Encryption
            Algorithm](#name-encryption-algorithm){.xref}
            :::

        -   ::: {#section-toc.1-1.4.2.3.2.4}
            [4.3.4](#section-4.3.4){.xref}.  [PRF and HASH
            Algorithms](#name-prf-and-hash-algorithms){.xref}
            :::

        -   ::: {#section-toc.1-1.4.2.3.2.5}
            [4.3.5](#section-4.3.5){.xref}.  [SNMAX
            Parameter](#name-snmax-parameter){.xref}
            :::
        :::
    :::

-   ::: {#section-toc.1-1.5}
    [5](#section-5){.xref}.  [New Values for the TLS SignatureAlgorithm
    Registry](#name-new-values-for-the-tls-sign){.xref}
    :::

-   ::: {#section-toc.1-1.6}
    [6](#section-6){.xref}.  [New Values for the TLS Supported Groups
    Registry](#name-new-values-for-the-tls-supp){.xref}
    :::

-   ::: {#section-toc.1-1.7}
    [7](#section-7){.xref}.  [New Values for the TLS
    ClientCertificateType Identifiers
    Registry](#name-new-values-for-the-tls-clie){.xref}
    :::

-   ::: {#section-toc.1-1.8}
    [8](#section-8){.xref}.  [Additional
    Algorithms](#name-additional-algorithms){.xref}

    -   ::: {#section-toc.1-1.8.2.1}
        [8.1](#section-8.1){.xref}.  [TLSTREE](#name-tlstree){.xref}

        -   ::: {#section-toc.1-1.8.2.1.2.1}
            [8.1.1](#section-8.1.1){.xref}.  [Key Tree
            Parameters](#name-key-tree-parameters){.xref}
            :::
        :::

    -   ::: {#section-toc.1-1.8.2.2}
        [8.2](#section-8.2){.xref}.  [Key Export and Key Import
        Algorithms](#name-key-export-and-key-import-a){.xref}

        -   ::: {#section-toc.1-1.8.2.2.2.1}
            [8.2.1](#section-8.2.1){.xref}.  [KExp15 and KImp15
            Algorithms](#name-kexp15-and-kimp15-algorithm){.xref}
            :::

        -   ::: {#section-toc.1-1.8.2.2.2.2}
            [8.2.2](#section-8.2.2){.xref}.  [KExp28147 and KImp28147
            Algorithms](#name-kexp28147-and-kimp28147-alg){.xref}
            :::
        :::

    -   ::: {#section-toc.1-1.8.2.3}
        [8.3](#section-8.3){.xref}.  [Key Exchange Generation
        Algorithms](#name-key-exchange-generation-alg){.xref}

        -   ::: {#section-toc.1-1.8.2.3.2.1}
            [8.3.1](#section-8.3.1){.xref}.  [KEG
            Algorithm](#name-keg-algorithm){.xref}
            :::

        -   ::: {#section-toc.1-1.8.2.3.2.2}
            [8.3.2](#section-8.3.2){.xref}.  [KEG_28147
            Algorithm](#name-keg_28147-algorithm){.xref}
            :::
        :::

    -   ::: {#section-toc.1-1.8.2.4}
        [8.4](#section-8.4){.xref}.  [gostIMIT28147](#name-gostimit28147){.xref}
        :::
    :::
...
-   ::: {#section-toc.1-1.13}
    ...
    -   ::: {#section-toc.1-1.13.2.1}
        [A.1](#appendix-A.1){.xref}.  [Test Examples for CTR_OMAC Cipher
        Suites](#name-test-examples-for-ctr_omac-){.xref}

        -   ::: {#section-toc.1-1.13.2.1.2.1}
            [A.1.1](#appendix-A.1.1){.xref}.  [TLSTREE
            Examples](#name-tlstree-examples){.xref}

            -   ::: {#section-toc.1-1.13.2.1.2.1.2.1}
                [A.1.1.1](#appendix-A.1.1.1){.xref}.  [TLS_GOSTR341112_256_WITH_MAGMA_CTR_OMAC
                Cipher Suite](#name-tls_gostr341112_256_with_ma){.xref}
                :::

            -   ::: {#section-toc.1-1.13.2.1.2.1.2.2}
                [A.1.1.2](#appendix-A.1.1.2){.xref}.  [TLS_GOSTR341112_256_WITH_KUZNYECHIK_CTR_OMAC
                Cipher Suite](#name-tls_gostr341112_256_with_ku){.xref}
                :::
            :::

        -   ::: {#section-toc.1-1.13.2.1.2.2}
            [A.1.2](#appendix-A.1.2){.xref}.  [Record
            Examples](#name-record-examples){.xref}

            -   ::: {#section-toc.1-1.13.2.1.2.2.2.1}
                [A.1.2.1](#appendix-A.1.2.1){.xref}.  [TLS_GOSTR341112_256_WITH_MAGMA_CTR_OMAC
                Cipher Suite](#name-tls_gostr341112_256_with_mag){.xref}
                :::

            -   ::: {#section-toc.1-1.13.2.1.2.2.2.2}
                [A.1.2.2](#appendix-A.1.2.2){.xref}.  [TLS_GOSTR341112_256_WITH_KUZNYECHIK_CTR_OMAC
                Cipher Suite](#name-tls_gostr341112_256_with_kuz){.xref}
                :::
            :::

        -   ::: {#section-toc.1-1.13.2.1.2.3}
            [A.1.3](#appendix-A.1.3){.xref}.  [Handshake
            Examples](#name-handshake-examples){.xref}

            -   ::: {#section-toc.1-1.13.2.1.2.3.2.1}
                [A.1.3.1](#appendix-A.1.3.1){.xref}.  [TLS_GOSTR341112_256_WITH_MAGMA_CTR_OMAC
                Cipher
                Suite](#name-tls_gostr341112_256_with_magm){.xref}
                :::

            -   ::: {#section-toc.1-1.13.2.1.2.3.2.2}
                [A.1.3.2](#appendix-A.1.3.2){.xref}.  [TLS_GOSTR341112_256_WITH_KUZNYECHIK_CTR_OMAC
                Cipher
                Suite](#name-tls_gostr341112_256_with_kuzn){.xref}
                :::
            :::
        :::

    -   ::: {#section-toc.1-1.13.2.2}
        [A.2](#appendix-A.2){.xref}.  [Test Examples for CNT_IMIT Cipher
        Suites](#name-test-examples-for-cnt_imit-){.xref}

        -   ::: {#section-toc.1-1.13.2.2.2.1}
            [A.2.1](#appendix-A.2.1){.xref}.  [Record
            Examples](#name-record-examples-2){.xref}
            :::

        -   ::: {#section-toc.1-1.13.2.2.2.2}
            [A.2.2](#appendix-A.2.2){.xref}.  [Handshake
            Examples](#name-handshake-examples-2){.xref}
            :::
        :::
    :::
...
This document specifies three new cipher suites, two new signature
algorithms, seven new supported groups, and two new certificate types
for the Transport Layer Security (TLS) protocol version 1.2
\[[RFC5246](#RFC5246){.xref}\] (note that \[[RFC5246](#RFC5246){.xref}\]
has been obsoleted by \[[RFC8446](#RFC8446){.xref}\] ) to support the
set of Russian cryptographic standard algorithms (called \"GOST\"
algorithms). This document specifies a profile of TLS 1.2 with GOST
algorithms so that implementers can produce interoperable
implementations. The profile of TLS 1.2 with GOST algorithms uses the
hash algorithm GOST R 34.11-2012 \[[RFC6986](#RFC6986){.xref}\], the
signature algorithm GOST R 34.10-2012 \[[RFC7091](#RFC7091){.xref}\],
and two types of cipher suites: the CTR_OMAC and the
CNT_IMIT.[¶](#section-1-1){.pilcrow}

The CTR_OMAC cipher suites use the GOST R 34.12-2015 (see
\[[RFC7801](#RFC7801){.xref}\] and \[[RFC8891](#RFC8891){.xref}\]) block
ciphers.[¶](#section-1-2){.pilcrow}

The CNT_IMIT cipher suite uses the GOST 28147-89
\[[RFC5830](#RFC5830){.xref}\] block cipher.[¶](#section-1-3){.pilcrow}

This document specifies the profile of the TLS protocol version 1.2 with
GOST algorithms. The profile of the TLS protocol version 1.3
\[[RFC8446](#RFC8446){.xref}\] with GOST algorithms is specified in a
separate document
\[[DraftGostTLS13](#I-D.smyshlyaev-tls13-gost-suites){.xref}\].[¶](#section-1-4){.pilcrow}

This specification facilitates implementations that aim to support the
GOST algorithms. This document does not imply IETF endorsement of the
cipher suites, signature algorithms, supported groups, and certificate
types.[¶](#section-1-5){.pilcrow}
:::
:::
...
\[[RFC8446bis](#I-D.ietf-tls-rfc8446bis){.xref}\] for \"preliminary
secret\" and \"extended_main_secret\".[¶](#section-3-1){.pilcrow}

This document uses the following terms and definitions for the sets and
operations on the elements of these sets:[¶](#section-3-2){.pilcrow}

[]{.break}

B_t
:   the set of byte strings of length t, t >= 0. For t = 0, the B_t set
    consists of a single empty string of zero length. If A is an element
    of B_t, then A = (a_1, a_2, \... , a_t), where a_1, a_2, \... , a_t
    are in {0, \... , 255}.[¶](#section-3-3.2){.pilcrow}
:   

B\*
:   the set of all byte strings of a finite length (hereinafter referred
    to as \"strings\"), including the empty
    string.[¶](#section-3-3.4){.pilcrow}
:   

A\[i..j\]
:   the string A\[i..j\] = (a_i, a\_{i+1}, \... , a_j) in B\_{j-i+1},
    where A = (a_1, \... , a_t) in B_t and
    1\<=i\<=j\<=t.[¶](#section-3-3.6){.pilcrow}
:   

L(A)
:   the length of the byte string A in
    bytes.[¶](#section-3-3.8){.pilcrow}
:   

A \| C
:   concatenation of strings A and C both belonging to B\*, i.e., a
    string in B\_{L(A)+L(C)}, where the left substring in B_L(A) is
    equal to A and the right substring in B_L(C) is equal to
    C.[¶](#section-3-3.10){.pilcrow}
:   

A XOR C
:   bitwise exclusive-or of byte strings A and C both belonging to B_t
    (both are of length t bytes), i.e., a string in B_t such that if A =
    (a_1, a_2, \... , a_t) and C = (c_1, c_2, \... , c_t), then A XOR C
    = (a_1 (xor) c_1, a_2 (xor) c_2, \... , a_t (xor) c_t), where (xor)
    is bitwise exclusive-or of bytes.[¶](#section-3-3.12){.pilcrow}
:   

i & j
:   bitwise AND of unsigned integers i and
    j.[¶](#section-3-3.14){.pilcrow}
:   

STR_t
:   the transformation that maps an integer i = 256^t-1^ \* i_1 + \... +
    256 \* i\_{t-1} + i_t into the byte string STR_t(i) = (i_1, \... ,
    i_t) in B_t (the interpretation of the integer as a byte string in
    big-endian format).[¶](#section-3-3.16){.pilcrow}
:   

str_t
:   the transformation that maps an integer i = 256^t-1^ \* i_t + \... +
    256 \* i_2 + i_1 into the byte string str_t(i) = (i_1, \... , i_t)
    in B_t (the interpretation of the integer as a byte string in
    little-endian format).[¶](#section-3-3.18){.pilcrow}
:   

INT
:   the transformation that maps a string a = (a_1, \... , a_t) in B_t
    into the integer INT(a) = 256^t-1^ \* a_1 + \... + 256 \* a\_{t-1} +
    a_t (the interpretation of the byte string in big-endian format as
    an integer).[¶](#section-3-3.20){.pilcrow}
:   

int
:   the transformation that maps a string a = (a_1, \... , a_t) in B_t
    into the integer int(a) = 256^t-1^ \* a_t + \... + 256 \* a_2 + a_1
    (the interpretation of the byte string in little-endian format as an
    integer).[¶](#section-3-3.22){.pilcrow}
:   

k
:   the length of the block cipher key in
    bytes.[¶](#section-3-3.24){.pilcrow}
:   

n
:   the length of the block cipher block in
    bytes.[¶](#section-3-3.26){.pilcrow}
:   

Q_c
:   the public key stored in the client\'s
    certificate.[¶](#section-3-3.28){.pilcrow}
:   

d_c
:   the private key that corresponds to the Q_c
    key.[¶](#section-3-3.30){.pilcrow}
:   

Q_s
:   the public key stored in the server\'s
    certificate.[¶](#section-3-3.32){.pilcrow}
:   

d_s
:   the private key that corresponds to the Q_s
    key.[¶](#section-3-3.34){.pilcrow}
:   

q_s
:   an order of a cyclic subgroup of the elliptic curve points group
    containing point Q_s.[¶](#section-3-3.36){.pilcrow}
:   

P_s
:   the distinguished generator of the subgroup of order q_s that
    belongs to the same curve as Q_s.[¶](#section-3-3.38){.pilcrow}
:   

r_c
:   the random string contained in the ClientHello.random field (see
    \[[RFC5246](#RFC5246){.xref}\]).[¶](#section-3-3.40){.pilcrow}
:   

r_s
:   the random string contained in the ServerHello.random field (see
    \[[RFC5246](#RFC5246){.xref}\]).[¶](#section-3-3.42){.pilcrow}
:   
:::
:::
...
::: {#CSD}
::: {#section-4 .section}
## [4.](#section-4){.section-number .selfRef} [Cipher Suite Definitions](#name-cipher-suite-definitions){.section-name .selfRef} {#name-cipher-suite-definitions}

This document specifies the CTR_OMAC cipher suites and the CNT_IMIT
cipher suite.[¶](#section-4-1){.pilcrow}

The CTR_OMAC cipher suites have the following
values:[¶](#section-4-2){.pilcrow}
...
::: {#RecordProtection}
::: {#section-4.1 .section}
### [4.1.](#section-4.1){.section-number .selfRef} [Record Payload Protection](#name-record-payload-protection){.section-name .selfRef} {#name-record-payload-protection}

The profile of TLS 1.2 with GOST algorithms requires that the
compression not be used.[¶](#section-4.1-1){.pilcrow}

All of the cipher suites described in this document use such modes of
operation (see [Section 4.3.3](#EncryptionAlgorithm){.xref}) that
protect the records in the same way as if they were protected by a
stream cipher. The TLSCiphertext structure for the CTR_OMAC and CNT_IMIT
cipher suites is specified in accordance with the standard stream cipher
case (see [Section
6.2.3.1](https://www.rfc-editor.org/rfc/rfc5246#section-6.2.3.1){.relref}
of \[[RFC5246](#RFC5246){.xref}\]):[¶](#section-4.1-2){.pilcrow}
...
where TLSCiphertext.fragment is generated in accordance with [Section
4.1.1](#TLSCiphertext_CTR_OMAC){.xref} when the CTR_OMAC cipher suites
are used and [Section 4.1.2](#TLSCiphertext_CNT_IMIT){.xref} when the
CNT_IMIT cipher suite is used.[¶](#section-4.1-4){.pilcrow}

The connection key material is a key material that consists of the
sender_write_key (either the client_write_key or the server_write_key),
the sender_write_MAC_key (either the client_write_MAC_key or the
server_write_MAC_key), and the sender_write_IV (either the
client_write_IV or the server_write_IV) parameters that are generated in
accordance with [Section
6.3](https://www.rfc-editor.org/rfc/rfc5246#section-6.3){.relref} of
\[[RFC5246](#RFC5246){.xref}\].[¶](#section-4.1-5){.pilcrow}

The record key material is a key material that is generated from the
connection key material and is used to protect a record with a certain
sequence number. Note that with some cipher suites defined in this
document, the record key material can be equal to the connection key
material.[¶](#section-4.1-6){.pilcrow}

In this section, the TLSCiphertext.fragment generation is described for
one particular endpoint (server or client) with the corresponding
connection key material and record key
material.[¶](#section-4.1-7){.pilcrow}

::: {#TLSCiphertext_CTR_OMAC}
::: {#section-4.1.1 .section}
#### [4.1.1.](#section-4.1.1){.section-number .selfRef} [CTR_OMAC](#name-ctr_omac){.section-name .selfRef} {#name-ctr_omac}

In the CTR_OMAC cipher suites, the record key material differs from the
connection key material, and for the seqnum sequence number consists
of:[¶](#section-4.1.1-1){.pilcrow}
...
TLSTREE function defined in [Section 8.1](#TLSTREE){.xref}, the
connection key material, and the seqnum sequence number . IV_seqnum is
calculated by adding the seqnum value to sender_write_IV modulo
2^(n/2)\*8^:[¶](#section-4.1.1-3){.pilcrow}
...
number is calculated as follows:[¶](#section-4.1.1-5){.pilcrow}

1.  ::: {#section-4.1.1-6.1}
    The MACValue_seqnum value is generated using the Message
    Authentication Code (MAC) algorithm (see [Section
    4.3.2](#MAC){.xref}) similar to [Section
    6.2.3.1](https://www.rfc-editor.org/rfc/rfc5246#section-6.2.3.1){.relref}
    of \[[RFC5246](#RFC5246){.xref}\], except the sender_write_MAC_key
    is replaced by the K_MAC_seqnum
    key:[¶](#section-4.1.1-6.1.1){.pilcrow}
    ...
    [¶](#section-4.1.1-6.1.2){.pilcrow}
    :::

    where type_seqnum, version_seqnum, length_seqnum, and
    fragment_seqnum are the TLSCompressed.type, TLSCompressed.version,
    TLSCompressed.length, and TLSCompressed.fragment values of the
    record with the seqnum sequence
    number.[¶](#section-4.1.1-6.1.3){.pilcrow}
    :::

2.  ::: {#section-4.1.1-6.2}
    The entire data with the MACValue is encrypted with the ENC stream
    cipher (see [Section
    4.3.3](#EncryptionAlgorithm){.xref}):[¶](#section-4.1.1-6.2.1){.pilcrow}
    ...
    [¶](#section-4.1.1-6.2.2){.pilcrow}
    :::

    where fragment_seqnum is the TLSCompressed.fragment value of the
    record with the seqnum sequence
    number.[¶](#section-4.1.1-6.2.3){.pilcrow}
    :::

3.  ::: {#section-4.1.1-6.3}
    The fields of the GenericStreamCipher structure (see [Section
    6.2.3.1](https://www.rfc-editor.org/rfc/rfc5246#section-6.2.3.1){.relref}
    of \[[RFC5246](#RFC5246){.xref}\]) for the TLSCiphertext.fragment
    value are defined by the ENCValue_seqnum
    value:[¶](#section-4.1.1-6.3.1){.pilcrow}
    ...
    [¶](#section-4.1.1-6.3.2){.pilcrow}
    :::

    where length_seqnum is the TLSCompressed.length value of the record
    with the seqnum sequence number and mac_length is equal to 16 for
    the TLS_GOSTR341112_256_WITH_KUZNYECHIK_CTR_OMAC cipher suite and 8
    for the TLS_GOSTR341112_256_WITH_MAGMA_CTR_OMAC cipher
    suite.[¶](#section-4.1.1-6.3.3){.pilcrow}
    :::

Note that the CTR_OMAC cipher suites use the authenticate-then-encrypt
method (see [Appendix
F.4](https://www.rfc-editor.org/rfc/rfc5246#appendix-F.4){.relref} of
\[[RFC5246](#RFC5246){.xref}\]). Since these ciphers are functioning as
stream ciphers, the authenticate-then-encrypt method is secure, and as
specified by \[[RFC7366](#RFC7366){.xref}\], the server that selects the
CTR_OMAC ciphers [MUST NOT]{.bcp14} send an encrypt_then_mac extension
to the client.[¶](#section-4.1.1-7){.pilcrow}
:::
:::

::: {#TLSCiphertext_CNT_IMIT}
::: {#section-4.1.2 .section}
#### [4.1.2.](#section-4.1.2){.section-number .selfRef} [CNT_IMIT](#name-cnt_imit){.section-name .selfRef} {#name-cnt_imit}

In the CNT_IMIT cipher suite, the record key material is equal to the
connection key material and consists of:[¶](#section-4.1.2-1){.pilcrow}
...
The TLSCiphertext.fragment that corresponds to the seqnum sequence
number is calculated as follows:[¶](#section-4.1.2-3){.pilcrow}

1.  ::: {#section-4.1.2-4.1}
    The MACValue_seqnum value is generated by the MAC algorithm (see
    [Section 4.3.2](#MAC){.xref}) as
    follows:[¶](#section-4.1.2-4.1.1){.pilcrow}
    ...
    [¶](#section-4.1.2-4.1.2){.pilcrow}
    :::

    where type_i, version_i, length_i, fragment_i, and i in {0, \... ,
    seqnum} are the TLSCompressed.type, TLSCompressed.version,
    TLSCompressed.length, and TLSCompressed.fragment values of the
    record with the i sequence
    number.[¶](#section-4.1.2-4.1.3){.pilcrow}

    Due to the use of the mode based on Cipher Block Chaining MAC
    (CBC-MAC) (see [Section 4.3.2](#MAC){.xref}), producing the
    MACValue_seqnum value does not mean processing all previous records.
    It is enough to store only an intermediate internal state of the MAC
    algorithm.[¶](#section-4.1.2-4.1.4){.pilcrow}
    :::

2.  ::: {#section-4.1.2-4.2}
    The entire data with the MACValue is encrypted with the ENC stream
    cipher (see [Section
    4.3.3](#EncryptionAlgorithm){.xref}):[¶](#section-4.1.2-4.2.1){.pilcrow}
    ...
    [¶](#section-4.1.2-4.2.2){.pilcrow}
    :::

    where the length of the byte string ENCValue_i in bytes is equal to
    the length of the byte string (fragment_i \| MACValue_i) in bytes
    and i in {0, \... , seqnum}.[¶](#section-4.1.2-4.2.3){.pilcrow}

    Due to the use of the stream cipher (see [Section
    4.3.3](#EncryptionAlgorithm){.xref}), producing the ENCValue_seqnum
    value does not mean processing all previous records. It is enough to
    store only an intermediate internal state of the ENC stream
    cipher.[¶](#section-4.1.2-4.2.4){.pilcrow}
    :::
...
3.  ::: {#section-4.1.2-4.3}
    ...
    of \[[RFC5246](#RFC5246){.xref}\]) for the TLSCiphertext.fragment
    value are defined by the ENCValue_seqnum
    value:[¶](#section-4.1.2-4.3.1){.pilcrow}
    ...
    [¶](#section-4.1.2-4.3.2){.pilcrow}
    :::

    where length_seqnum is the TLSCompressed.length value of the record
    with the seqnum sequence number, and mac_length is equal to
    4.[¶](#section-4.1.2-4.3.3){.pilcrow}
    :::

Note that the CNT_IMIT cipher suite uses the authenticate-then-encrypt
method (see [Appendix
F.4](https://www.rfc-editor.org/rfc/rfc5246#appendix-F.4){.relref} of
\[[RFC5246](#RFC5246){.xref}\]). Since this cipher is functioning as a
stream cipher, the authenticate-then-encrypt method is secure, and as
specified by \[[RFC7366](#RFC7366){.xref}\], the server that selects the
CNT_IMIT cipher [MUST NOT]{.bcp14} send an encrypt_then_mac extension to
the client.[¶](#section-4.1.2-5){.pilcrow}
:::
:::
:::
:::
...
::: {#section-4.2 .section}
### [4.2.](#section-4.2){.section-number .selfRef} [Key Exchange and Authentication](#name-key-exchange-and-authentica){.section-name .selfRef} {#name-key-exchange-and-authentica}
...
secret.[¶](#section-4.2-1){.pilcrow}

[]{#name-message-flow-for-a-full-han}
...
[Figure 1](#figure-1){.selfRef}: [Message Flow for a Full
Handshake](#name-message-flow-for-a-full-han){.selfRef}
:::

Notes for [Figure 1](#fig1){.xref}:[¶](#section-4.2-3){.pilcrow}

1.  [\"\*\" indicates optional messages that are sent for the client
    authentication.[¶](#section-4.2-4.1){.pilcrow}]{#section-4.2-4.1}
2.  [To help avoid pipeline stalls, ChangeCipherSpec is an independent
    ...
    message.[¶](#section-4.2-4.2){.pilcrow}]{#section-4.2-4.2}

[Figure 1](#fig1){.xref} shows all messages involved in the TLS key
establishment protocol (full handshake). A ServerKeyExchange [MUST
NOT]{.bcp14} be sent (the server\'s certificate contains enough data to
allow the client to exchange the preliminary
secret).[¶](#section-4.2-5){.pilcrow}

The server side of the channel is always authenticated; the client side
is optionally authenticated. The server is authenticated by proving that
it knows the preliminary secret that is encrypted with the public key
Q_s from the server\'s certificate. The client is authenticated via its
signature over the handshake transcript.[¶](#section-4.2-6){.pilcrow}

In general, the key exchange process for both the CTR_OMAC and CNT_IMIT
cipher suites consists of the following
steps:[¶](#section-4.2-7){.pilcrow}

1.  [The client generates the ephemeral key pair (d_eph, Q_eph) that
    corresponds to the server\'s public key Q_s stored in its
    certificate.[¶](#section-4.2-8.1){.pilcrow}]{#section-4.2-8.1}
2.  [The client generates the preliminary secret PS. The PS value is
    chosen from B_32 at
    random.[¶](#section-4.2-8.2){.pilcrow}]{#section-4.2-8.2}
3.  [Using d_eph and Q_s, the client generates the export key material
    (see Sections [4.2.4.1](#CTRkeygen){.xref} and
    [4.2.4.2](#CNTkeygen){.xref}) for the particular key export
    algorithm (see Sections [8.2.1](#KExpImp15){.xref} and
    [8.2.2](#KExpImp28147){.xref}) to generate the export representation
    PSExp of the PS
    value.[¶](#section-4.2-8.3){.pilcrow}]{#section-4.2-8.3}
4.  [The client sends its ephemeral public key Q_eph and PSExp value in
    the ClientKeyExchange
    message.[¶](#section-4.2-8.4){.pilcrow}]{#section-4.2-8.4}
5.  [Using its private key d_s, the server generates the import key
    material (see Sections [4.2.4.1](#CTRkeygen){.xref} and
    [4.2.4.2](#CNTkeygen){.xref}) for the particular key import
    algorithm (see Sections [8.2.1](#KExpImp15){.xref} and
    [8.2.2](#KExpImp28147){.xref}) to extract the preliminary secret PS
    from the export representation
    PSExp.[¶](#section-4.2-8.5){.pilcrow}]{#section-4.2-8.5}

This section specifies the data structures and computations used by the
profile of TLS 1.2 with GOST algorithms. The specifications for the
ClientHello, ServerHello, Server Certificate, CertificateRequest,
ClientKeyExchange, CertificateVerify, and Finished handshake messages
are described in further detail below.[¶](#section-4.2-9){.pilcrow}

::: {#Hello}
::: {#section-4.2.1 .section}
#### [4.2.1.](#section-4.2.1){.section-number .selfRef} [Hello Messages](#name-hello-messages){.section-name .selfRef} {#name-hello-messages}

The ClientHello message is generated in accordance with [Section
7.4.1.2](https://www.rfc-editor.org/rfc/rfc5246#section-7.4.1.2){.relref}
of \[[RFC5246](#RFC5246){.xref}\] and must meet the following
requirements:[¶](#section-4.2.1-1){.pilcrow}

-   [The ClientHello.compression_methods field [MUST]{.bcp14} contain
    exactly one byte, set to zero, which corresponds to the \"null\"
    compression
    method.[¶](#section-4.2.1-2.1){.pilcrow}]{#section-4.2.1-2.1}

-   ::: {#section-4.2.1-2.2}
    The ClientHello.extensions field [MUST]{.bcp14} contain the
    signature_algorithms extension (see
    \[[RFC5246](#RFC5246){.xref}\]).[¶](#section-4.2.1-2.2.1){.pilcrow}
    ...
    contain the values defined in [Section 5](#SAR){.xref}, the server
    [MUST]{.bcp14} either abort the connection or ignore this extension
    and behave as if the client had sent the signature_algorithms
    extension with the values {8, 64} and {8,
    65}.[¶](#section-4.2.1-2.2.2){.pilcrow}
    :::

The ServerHello message is generated in accordance with [Section
7.4.1.3](https://www.rfc-editor.org/rfc/rfc5246#section-7.4.1.3){.relref}
of \[[RFC5246](#RFC5246){.xref}\] and must meet the following
requirements:[¶](#section-4.2.1-3){.pilcrow}

-   [The ServerHello.compression_method field [MUST]{.bcp14} contain
    exactly one byte, set to zero, which corresponds to the \"null\"
    compression
    method.[¶](#section-4.2.1-4.1){.pilcrow}]{#section-4.2.1-4.1}
-   [The ServerHello.extensions field [MUST NOT]{.bcp14} contain the
    encrypt_then_mac extension (see
    \[[RFC7366](#RFC7366){.xref}\]).[¶](#section-4.2.1-4.2){.pilcrow}]{#section-4.2.1-4.2}
:::
:::

::: {#section-4.2.2 .section}
#### [4.2.2.](#section-4.2.2){.section-number .selfRef} [Server Certificate](#name-server-certificate){.section-name .selfRef} {#name-server-certificate}

This message is used to authentically convey the server\'s public key
Q_s to the client and is generated in accordance with [Section
7.4.2](https://www.rfc-editor.org/rfc/rfc5246#section-7.4.2){.relref} of
\[[RFC5246](#RFC5246){.xref}\].[¶](#section-4.2.2-1){.pilcrow}

Upon receiving this message, the client validates the certificate chain,
extracts the server\'s public key, and checks that the key type is
appropriate for the negotiated key exchange algorithm. (A possible
reason for a fatal handshake failure is that the client\'s capabilities
for handling elliptic curves and point formats are
exceeded).[¶](#section-4.2.2-2){.pilcrow}
:::

::: {#section-4.2.3 .section}
#### [4.2.3.](#section-4.2.3){.section-number .selfRef} [CertificateRequest](#name-certificaterequest){.section-name .selfRef} {#name-certificaterequest}

This message is sent by the server when requesting client authentication
and is generated in accordance with [Section
7.4.4](https://www.rfc-editor.org/rfc/rfc5246#section-7.4.4){.relref} of
\[[RFC5246](#RFC5246){.xref}\].[¶](#section-4.2.3-1){.pilcrow}

If the CTR_OMAC or CNT_IMIT cipher suite is negotiated, the
CertificateRequest message [MUST]{.bcp14} meet the following
requirements:[¶](#section-4.2.3-2){.pilcrow}

-   [the CertificateRequest.supported_signature_algorithm field
    [MUST]{.bcp14} contain only signature/hash algorithm pairs with the
    values {8, 64} or {8, 65} defined in [Section
    5](#SAR){.xref};[¶](#section-4.2.3-3.1){.pilcrow}]{#section-4.2.3-3.1}
-   [the CertificateRequest.certificate_types field [MUST]{.bcp14}
    contain only the gost_sign256 (67) or gost_sign512 (68) values
    defined in [Section
    7](#CTIR){.xref}.[¶](#section-4.2.3-3.2){.pilcrow}]{#section-4.2.3-3.2}
:::

::: {#section-4.2.4 .section}
#### [4.2.4.](#section-4.2.4){.section-number .selfRef} [ClientKeyExchange](#name-clientkeyexchange){.section-name .selfRef} {#name-clientkeyexchange}

The ClientKeyExchange message is defined as
...
export representation of the preliminary secret
PS.[¶](#section-4.2.4-3){.pilcrow}

The GostKeyTransport structure corresponds to the CTR_OMAC cipher suites
and is described in [Section 4.2.4.1](#CTRkeygen){.xref}, and the
TLSGostKeyTransportBlob structure corresponds to the CNT_IMIT cipher
suite and is described in [Section
4.2.4.2](#CNTkeygen){.xref}.[¶](#section-4.2.4-4){.pilcrow}

The DER encoding rules are used to encode the GostKeyTransport and the
TLSGostKeyTransportBlob structures.[¶](#section-4.2.4-5){.pilcrow}

::: {#CTRkeygen}
::: {#section-4.2.4.1 .section}
##### [4.2.4.1.](#section-4.2.4.1){.section-number .selfRef} [CTR_OMAC](#name-ctr_omac-2){.section-name .selfRef} {#name-ctr_omac-2}

In the CTR_OMAC cipher suites, the body of the ClientKeyExchange message
consists of the GostKeyTransport structure that is defined
below.[¶](#section-4.2.4.1-1){.pilcrow}

The client generates the ClientKeyExchange message in accordance with
the following steps:[¶](#section-4.2.4.1-2){.pilcrow}

1.  ::: {#section-4.2.4.1-3.1}
    Generates the ephemeral key pair (Q_eph, d_eph),
    where:[¶](#section-4.2.4.1-3.1.1){.pilcrow}

    ::: {#section-4.2.4.1-3.1.2}
    ``` sourcecode
    ...
    [¶](#section-4.2.4.1-3.1.2){.pilcrow}
    :::
    :::

2.  ::: {#section-4.2.4.1-3.2}
    Generates the preliminary secret PS, where PS is chosen from B_32 at
    random.[¶](#section-4.2.4.1-3.2.1){.pilcrow}
    :::

3.  ::: {#section-4.2.4.1-3.3}
    Generates export keys (K_EXP_MAC and K_EXP_ENC) using the KEG
    algorithm defined in [Section
    8.3.1](#KEG){.xref}:[¶](#section-4.2.4.1-3.3.1){.pilcrow}

    ::: {#section-4.2.4.1-3.3.2}
    ``` sourcecode
    H = HASH(r_c | r_s);
    ...
    [¶](#section-4.2.4.1-3.3.2){.pilcrow}
    :::
    :::

4.  ::: {#section-4.2.4.1-3.4}
    Generates an export representation PSExp of the preliminary secret
    PS using the KExp15 algorithm defined in [Section
    8.2.1](#KExpImp15){.xref}:[¶](#section-4.2.4.1-3.4.1){.pilcrow}

    ::: {#section-4.2.4.1-3.4.2}
    ``` sourcecode
    IV = H[25..24 + n / 2];
    ...
    [¶](#section-4.2.4.1-3.4.2){.pilcrow}
    :::
    :::

5.  ::: {#section-4.2.4.1-3.5}
    Generates the ClientKeyExchange message using the GostKeyTransport
    structure that is defined as
    follows:[¶](#section-4.2.4.1-3.5.1){.pilcrow}

    ::: {#section-4.2.4.1-3.5.2}
    ``` {.lang-asn.1 .sourcecode}
    ...
    server.[¶](#section-4.2.4.1-3.5.3){.pilcrow}
    :::

Upon receiving the ClientKeyExchange message, the server process is as
follows.[¶](#section-4.2.4.1-4){.pilcrow}

1.  ::: {#section-4.2.4.1-5.1}
    The following three conditions are checked. If any of these checks
    fail, then the server [MUST]{.bcp14} abort the handshake with an
    alert.[¶](#section-4.2.4.1-5.1.1){.pilcrow}

    -   [Q_eph belongs to the same curve as server public key
        Q_s;[¶](#section-4.2.4.1-5.1.2.1){.pilcrow}]{#section-4.2.4.1-5.1.2.1}
    -   [Q_eph is not equal to zero
        point;[¶](#section-4.2.4.1-5.1.2.2){.pilcrow}]{#section-4.2.4.1-5.1.2.2}
    -   [q_s \* Q_eph is equal to zero
        point.[¶](#section-4.2.4.1-5.1.2.3){.pilcrow}]{#section-4.2.4.1-5.1.2.3}
    :::

2.  ::: {#section-4.2.4.1-5.2}
    The export keys (K_EXP_MAC and K_EXP_ENC) are generated using the
    KEG algorithm defined in [Section
    8.3.1](#KEG){.xref}:[¶](#section-4.2.4.1-5.2.1){.pilcrow}

    ::: {#section-4.2.4.1-5.2.2}
    ``` sourcecode
    H = HASH(r_c | r_s);
    ...
    [¶](#section-4.2.4.1-5.2.2){.pilcrow}
    :::
    :::

3.  ::: {#section-4.2.4.1-5.3}
    The preliminary secret PS is extracted from the export
    representation PSExp using the KImp15 algorithm defined in [Section
    8.2.1](#KExpImp15){.xref}:[¶](#section-4.2.4.1-5.3.1){.pilcrow}

    ::: {#section-4.2.4.1-5.3.2}
    ``` sourcecode
    IV = H[25..24 + n / 2];
...
##### [4.2.4.2.](#section-4.2.4.2){.section-number .selfRef} [CNT_IMIT](#name-cnt_imit-2){.section-name .selfRef} {#name-cnt_imit-2}

In the CNT_IMIT cipher suite, the body of the ClientKeyExchange message
consists of a TLSGostKeyTransportBlob structure that is defined
below.[¶](#section-4.2.4.2-1){.pilcrow}

The client generates the ClientKeyExchange message in accordance with
the following steps:[¶](#section-4.2.4.2-2){.pilcrow}

1.  ::: {#section-4.2.4.2-3.1}
    The ephemeral key pair (Q_eph, d_eph) is generated,
    where:[¶](#section-4.2.4.2-3.1.1){.pilcrow}

    ::: {#section-4.2.4.2-3.1.2}
    ``` sourcecode
    d_eph is chosen from {1, ... , q_s - 1} at random;
    ...
    [¶](#section-4.2.4.2-3.1.2){.pilcrow}
    :::
    :::

2.  [The preliminary secret PS is generated, where PS is chosen from
    B_32 at
    random.[¶](#section-4.2.4.2-3.2){.pilcrow}]{#section-4.2.4.2-3.2}

3.  ::: {#section-4.2.4.2-3.3}
    The export key (K_EXP) is generated using the KEG_28147 algorithm
    defined in [Section
    8.3.2](#KEG_28147){.xref}:[¶](#section-4.2.4.2-3.3.1){.pilcrow}

    ::: {#section-4.2.4.2-3.3.2}
    ``` sourcecode
    H = HASH(r_c | r_s);
    ...
    [¶](#section-4.2.4.2-3.3.2){.pilcrow}
    :::
    :::

4.  ::: {#section-4.2.4.2-3.4}
    An export representation PSExp of the preliminary secret PS using
    the KExp28147 algorithm defined in [Section
    8.2.2](#KExpImp28147){.xref} is
    generated:[¶](#section-4.2.4.2-3.4.1){.pilcrow}

    ::: {#section-4.2.4.2-3.4.2}
    ``` sourcecode
    PSExp = IV | CEK_ENC | CEK_MAC = KExp28147(PS, K_EXP, H[1..8]).
    ```

    [¶](#section-4.2.4.2-3.4.2){.pilcrow}
    :::
    :::

5.  ::: {#section-4.2.4.2-3.5}
    The ClientKeyExchange message is generated using the
    TLSGostKeyTransportBlob structure that is defined as
    follows:[¶](#section-4.2.4.2-3.5.1){.pilcrow}

    ::: {#section-4.2.4.2-3.5.2}
    ``` {.lang-asn.1 .sourcecode}
    ...
    [¶](#section-4.2.4.2-3.5.2){.pilcrow}
    :::

    where GostR3410-KeyTransport, Gost28147-89-EncryptedKey, and
    GostR3410-TransportParameters are defined according to [Section
    4.2.1](https://www.rfc-editor.org/rfc/rfc4490#section-4.2.1){.relref}
    of
    \[[RFC4490](#RFC4490){.xref}\].[¶](#section-4.2.4.2-3.5.3){.pilcrow}
    :::
...
GostR3410-KeyTransport.transportParameters.ephemeralPublicKey field is
always used.[¶](#section-4.2.4.2-4){.pilcrow}

The Gost28147-89-EncryptedKey.encryptedKey field contains the CEK_ENC
value, the Gost28147-89-EncryptedKey.macKey field contains the CEK_MAC
value, and the GostR3410-TransportParameters.ukm field contains the
initialization vector (IV) value.[¶](#section-4.2.4.2-5){.pilcrow}

The keyBlob.transportParameters.ephemeralPublicKey field contains the
client ephemeral public key Q_eph. The encryptionParamSet contains the
value 1.2.643.7.1.2.5.1.1, which corresponds to the
id-tc26-gost-28147-param-Z parameters set defined in
\[[RFC7836](#RFC7836){.xref}\].[¶](#section-4.2.4.2-6){.pilcrow}

Upon receiving the ClientKeyExchange message, the server process is as
follows.[¶](#section-4.2.4.2-7){.pilcrow}

1.  ::: {#section-4.2.4.2-8.1}
    The following three conditions are checked. If either of these
    checks fails, then the server [MUST]{.bcp14} abort the handshake
    with an alert.[¶](#section-4.2.4.2-8.1.1){.pilcrow}

    -   [Q_eph belongs to the same curve as server public key
        Q_s;[¶](#section-4.2.4.2-8.1.2.1){.pilcrow}]{#section-4.2.4.2-8.1.2.1}
    -   [Q_eph is not equal to zero
        point;[¶](#section-4.2.4.2-8.1.2.2){.pilcrow}]{#section-4.2.4.2-8.1.2.2}
    -   [q_s \* Q_eph is equal to zero
        point.[¶](#section-4.2.4.2-8.1.2.3){.pilcrow}]{#section-4.2.4.2-8.1.2.3}
    :::

2.  ::: {#section-4.2.4.2-8.2}
    The export key (K_EXP) is generated using the KEG_28147 algorithm
    defined in [Section
    8.3.2](#KEG_28147){.xref}:[¶](#section-4.2.4.2-8.2.1){.pilcrow}

    ::: {#section-4.2.4.2-8.2.2}
    ``` sourcecode
    H = HASH(r_c | r_s);
    ...
    [¶](#section-4.2.4.2-8.2.2){.pilcrow}
    :::
    :::

3.  ::: {#section-4.2.4.2-8.3}
    The preliminary secret PS is extracted from the export
    representation PSExp using the KImp28147 algorithm defined in
    [Section
    8.2.2](#KExpImp28147){.xref}:[¶](#section-4.2.4.2-8.3.1){.pilcrow}

    ::: {#section-4.2.4.2-8.3.2}
    ``` sourcecode
    PS = KImp28147(PSExp, K_EXP, H[1..8]).
    ```

    [¶](#section-4.2.4.2-8.3.2){.pilcrow}
    :::
    :::
:::
:::
...
#### [4.2.5.](#section-4.2.5){.section-number .selfRef} [CertificateVerify](#name-certificateverify){.section-name .selfRef} {#name-certificateverify}

The client generates the value sgn as
follows:[¶](#section-4.2.5-1){.pilcrow}
...
[¶](#section-4.2.5-2){.pilcrow}
:::

where SIGN\_{d_c} is the GOST R 34.10-2012
\[[RFC7091](#RFC7091){.xref}\] signature algorithm, d_c is a client
long-term private key that corresponds to the client long-term public
key Q_c from the client\'s certificate, l = 32 for the gostr34102012_256
value of the SignatureAndHashAlgorithm field, and l = 64 for the
gostr34102012_512 value of the SignatureAndHashAlgorithm
field.[¶](#section-4.2.5-3){.pilcrow}
...
handshake messages.[¶](#section-4.2.5-4){.pilcrow}

The TLS CertificateVerify message is specified as
follows:[¶](#section-4.2.5-5){.pilcrow}
...
[¶](#section-4.2.5-6){.pilcrow}
:::

where the SignatureAndHashAlgorithm structure is specified in [Section
5](#SAR){.xref}, and the CertificateVerify.signature field contains the
sgn value.[¶](#section-4.2.5-7){.pilcrow}
:::
:::

::: {#section-4.2.6 .section}
#### [4.2.6.](#section-4.2.6){.section-number .selfRef} [Finished](#name-finished){.section-name .selfRef} {#name-finished}

The TLS Finished message is generated in accordance with [Section
7.4.9](https://www.rfc-editor.org/rfc/rfc5246#section-7.4.9){.relref} of
\[[RFC5246](#RFC5246){.xref}\].[¶](#section-4.2.6-1){.pilcrow}
...
pseudorandom function (PRF) is defined in [Section
4.3.4](#PRFHASH){.xref}.[¶](#section-4.2.6-2){.pilcrow}
:::
:::

::: {#section-4.3 .section}
### [4.3.](#section-4.3){.section-number .selfRef} [Cryptographic Algorithms](#name-cryptographic-algorithms){.section-name .selfRef} {#name-cryptographic-algorithms}

::: {#BlockCipher}
::: {#section-4.3.1 .section}
#### [4.3.1.](#section-4.3.1){.section-number .selfRef} [Block Cipher](#name-block-cipher){.section-name .selfRef} {#name-block-cipher}

The cipher suite TLS_GOSTR341112_256_WITH_KUZNYECHIK_CTR_OMAC
[MUST]{.bcp14} use Kuznyechik \[[RFC7801](#RFC7801){.xref}\] as a base
block cipher for the encryption and MAC algorithm. The block length n is
16 bytes, and the key length k is 32
bytes.[¶](#section-4.3.1-1){.pilcrow}

The cipher suite TLS_GOSTR341112_256_WITH_MAGMA_CTR_OMAC [MUST]{.bcp14}
use Magma \[[RFC8891](#RFC8891){.xref}\] as a base block cipher for the
encryption and MAC algorithm. The block length n is 8 bytes, and the key
length k is 32 bytes.[¶](#section-4.3.1-2){.pilcrow}

The cipher suite TLS_GOSTR341112_256_WITH_28147_CNT_IMIT [MUST]{.bcp14}
use GOST 28147-89 as a base block cipher \[[RFC5830](#RFC5830){.xref}\]
with the set of parameters id-tc26-gost-28147-param-Z defined in
\[[RFC7836](#RFC7836){.xref}\]. The block length n is 8 bytes, and the
key length k is 32 bytes.[¶](#section-4.3.1-3){.pilcrow}
:::
:::

::: {#MAC}
::: {#section-4.3.2 .section}
#### [4.3.2.](#section-4.3.2){.section-number .selfRef} [MAC Algorithm](#name-mac-algorithm){.section-name .selfRef} {#name-mac-algorithm}

The CTR_OMAC cipher suites use the One-Key MAC (OMAC) construction
defined in \[[GOST3413-2015](#GOST3413-2015){.xref}\], which is the same
as the Cipher-Based MAC (CMAC) mode defined in \[[CMAC](#CMAC){.xref}\]
where the Kuznyechik or Magma block cipher (see [Section
4.3.1](#BlockCipher){.xref}) is used instead of the AES block cipher
(see \[[IK2003](#IK2003){.xref}\] for more detail) as the MAC function.
The resulting MAC length is equal to the block length, and the MAC key
length is 32 bytes.[¶](#section-4.3.2-1){.pilcrow}

The CNT_IMIT cipher suite uses the MAC function gostIMIT28147 defined in
[Section 8.4](#IMIT){.xref} with the initialization vector IV = IV0,
where IV0 in B_8 is a string of all zeros, with the CryptoPro Key
Meshing algorithm defined in \[[RFC4357](#RFC4357){.xref}\]. The
resulting MAC length is 4 bytes, and the MAC key length is 32
bytes.[¶](#section-4.3.2-2){.pilcrow}
:::
:::

::: {#EncryptionAlgorithm}
::: {#section-4.3.3 .section}
#### [4.3.3.](#section-4.3.3){.section-number .selfRef} [Encryption Algorithm](#name-encryption-algorithm){.section-name .selfRef} {#name-encryption-algorithm}

The CTR_OMAC cipher suites use the block cipher in the CTR-ACPKM
encryption mode defined in \[[RFC8645](#RFC8645){.xref}\] as the ENC
function. The section size N is 4 KB for the
TLS_GOSTR341112_256_WITH_KUZNYECHIK_CTR_OMAC cipher suite and 1 KB for
the TLS_GOSTR341112_256_WITH_MAGMA_CTR_OMAC cipher
suite.[¶](#section-4.3.3-1){.pilcrow}

The CNT_IMIT cipher suite uses the block cipher in counter encryption
mode (CNT) defined in [Section
6](https://www.rfc-editor.org/rfc/rfc5830#section-6){.relref} of
\[[RFC5830](#RFC5830){.xref}\], with the CryptoPro key meshing algorithm
defined in \[[RFC4357](#RFC4357){.xref}\] as the ENC
function.[¶](#section-4.3.3-2){.pilcrow}

Note that the counter modes used in cipher suites described in this
document act as stream ciphers.[¶](#section-4.3.3-3){.pilcrow}
:::
:::

::: {#PRFHASH}
::: {#section-4.3.4 .section}
#### [4.3.4.](#section-4.3.4){.section-number .selfRef} [PRF and HASH Algorithms](#name-prf-and-hash-algorithms){.section-name .selfRef} {#name-prf-and-hash-algorithms}

The PRF for all the cipher suites defined in this document is the
PRF_TLS_GOSTR3411_2012_256 function defined in
\[[RFC7836](#RFC7836){.xref}\].[¶](#section-4.3.4-1){.pilcrow}

The hash function HASH for all the cipher suites defined in this
document is the GOST R 34.11-2012 \[[RFC6986](#RFC6986){.xref}\] hash
algorithm with a 32-byte (256-bit) hash
code.[¶](#section-4.3.4-2){.pilcrow}
:::
:::

::: {#section-4.3.5 .section}
#### [4.3.5.](#section-4.3.5){.section-number .selfRef} [SNMAX Parameter](#name-snmax-parameter){.section-name .selfRef} {#name-snmax-parameter}

The SNMAX parameter defines the maximal value of the seqnum sequence
number during one TLS 1.2 connection and is defined as
follows:[¶](#section-4.3.5-1){.pilcrow}

+-----------------------------------+-----------------------------------+
| Cipher Suites                     | SNMAX                             |
+===================================+===================================+
| -   [TLS_GOSTR341112              | SNMAX = 2^64^ - 1                 |
| _256_WITH_KUZNYECHIK_CTR_OMAC[¶]( |                                   |
| #section-4.3.5-2.2.1.1.1.1){.pilc |                                   |
| row}]{#section-4.3.5-2.2.1.1.1.1} |                                   |
| -   [TLS_GOSTR3                   |                                   |
| 41112_256_WITH_28147_CNT_IMIT[¶]( |                                   |
| #section-4.3.5-2.2.1.1.1.2){.pilc |                                   |
| row}]{#section-4.3.5-2.2.1.1.1.2} |                                   |
+-----------------------------------+-----------------------------------+
| TLS_GO                            | SNMAX = 2^32^ - 1                 |
| STR341112_256_WITH_MAGMA_CTR_OMAC |                                   |
+-----------------------------------+-----------------------------------+
...
::: {#SAR}
::: {#section-5 .section}
## [5.](#section-5){.section-number .selfRef} [New Values for the TLS SignatureAlgorithm Registry](#name-new-values-for-the-tls-sign){.section-name .selfRef} {#name-new-values-for-the-tls-sign}

The signature/hash algorithm pairs are used to indicate to the
server/client which algorithms can be used in digital signatures and are
defined by the SignatureAndHashAlgorithm structure (see [Section
7.4.1.4.1](https://www.rfc-editor.org/rfc/rfc5246#section-7.4.1.4.1){.relref}
of \[[RFC5246](#RFC5246){.xref}\]).[¶](#section-5-1){.pilcrow}
...
field for the particular signature/hash algorithm
pair:[¶](#section-5-2){.pilcrow}
...
the GOST R 34.10-2012 \[[RFC7091](#RFC7091){.xref}\] signature algorithm
with a 32-byte (256-bit) and 64-byte (512-bit) key length,
respectively.[¶](#section-5-4){.pilcrow}

According to \[[RFC7091](#RFC7091){.xref}\], the GOST R 34.10-2012
signature algorithm with a 32-byte (256-bit) or 64-byte (512-bit) key
length uses the GOST R 34.11-2012 \[[RFC6986](#RFC6986){.xref}\] hash
algorithm with a 32-byte (256-bit) or 64-byte (512-bit) hash code,
respectively (the hash algorithm is intrinsic to the signature
algorithm). Therefore, if the SignatureAndHashAlgorithm.signature field
of a particular hash/signature pair listed in the Signature Algorithms
Extension is equal to the 64 (gostr34102012_256) or 65
(gostr34102012_512) value, the SignatureAndHashAlgorithm.hash field of
this pair [MUST]{.bcp14} contain the \"Intrinsic\" value 8 (see
\[[RFC8422](#RFC8422){.xref}\]).[¶](#section-5-5){.pilcrow}
...
respectively.[¶](#section-5-6){.pilcrow}
:::
:::

::: {#SGR}
::: {#section-6 .section}
## [6.](#section-6){.section-number .selfRef} [New Values for the TLS Supported Groups Registry](#name-new-values-for-the-tls-supp){.section-name .selfRef} {#name-new-values-for-the-tls-supp}

The Supported Groups Extension indicates the set of elliptic curves
supported by the client and is defined in \[[RFC8422](#RFC8422){.xref}\]
and \[[RFC7919](#RFC7919){.xref}\].[¶](#section-6-1){.pilcrow}
...
where the values correspond to the following
curves:[¶](#section-6-4){.pilcrow}

::: {#tab-2}
  Description   Curve Identifier Value                   Reference
  ------------- ---------------------------------------- --------------------------------
  GC256A        id-tc26-gost-3410-2012-256-paramSetA     \[[RFC7836](#RFC7836){.xref}\]
  GC256B        id-GostR3410-2001-CryptoPro-A-ParamSet   \[[RFC4357](#RFC4357){.xref}\]
  GC256C        id-GostR3410-2001-CryptoPro-B-ParamSet   \[[RFC4357](#RFC4357){.xref}\]
  GC256D        id-GostR3410-2001-CryptoPro-C-ParamSet   \[[RFC4357](#RFC4357){.xref}\]
  GC512A        id-tc26-gost-3410-12-512-paramSetA       \[[RFC7836](#RFC7836){.xref}\]
  GC512B        id-tc26-gost-3410-12-512-paramSetB       \[[RFC7836](#RFC7836){.xref}\]
  GC512C        id-tc26-gost-3410-2012-512-paramSetC     \[[RFC7836](#RFC7836){.xref}\]
...
::: {#CTIR}
::: {#section-7 .section}
## [7.](#section-7){.section-number .selfRef} [New Values for the TLS ClientCertificateType Identifiers Registry](#name-new-values-for-the-tls-clie){.section-name .selfRef} {#name-new-values-for-the-tls-clie}
...
defined in [Section
7.4.4](https://www.rfc-editor.org/rfc/rfc5246#section-7.4.4){.relref} of
\[[RFC5246](#RFC5246){.xref}\].[¶](#section-7-1){.pilcrow}

This document defines new values for the \"TLS ClientCertificateType
Identifiers\" registry:[¶](#section-7-2){.pilcrow}
...
client [MUST]{.bcp14} possess a certificate containing a GOST R
34.10-2012-capable public key that corresponds to the 32-byte (256-bit)
or 64-byte (512-bit) signature key,
respectively.[¶](#section-7-4){.pilcrow}

The client proves possession of the private key corresponding to the
certified key by including a signature in the CertificateVerify message
as described in [Section
4.2.5](#CertVer){.xref}.[¶](#section-7-5){.pilcrow}
:::
:::

::: {#UA}
::: {#section-8 .section}
## [8.](#section-8){.section-number .selfRef} [Additional Algorithms](#name-additional-algorithms){.section-name .selfRef} {#name-additional-algorithms}

The cipher suites specified in this document rely on some additional
algorithms, specified below; the use of these algorithms is not confined
to the use in TLS specified in this document.[¶](#section-8-1){.pilcrow}

::: {#TLSTREE}
::: {#section-8.1 .section}
### [8.1.](#section-8.1){.section-number .selfRef} [TLSTREE](#name-tlstree){.section-name .selfRef} {#name-tlstree}

The TLSTREE function is defined as follows:[¶](#section-8.1-1){.pilcrow}
...
where[¶](#section-8.1-3){.pilcrow}

-   [K_root in B_32;[¶](#section-8.1-4.1){.pilcrow}]{#section-8.1-4.1}

-   [i in {0, 1, \... , 2^64^ -
    1};[¶](#section-8.1-4.2){.pilcrow}]{#section-8.1-4.2}

-   [C_1, C_2, C_3 are constants defined by the particular cipher suite
    (see [Section
    8.1.1](#TreeParam){.xref});[¶](#section-8.1-4.3){.pilcrow}]{#section-8.1-4.3}

-   ::: {#section-8.1-4.4}
    KDF_j(K, D), j = 1, 2, 3, K in B_32, D in B_8, is the key derivation
    function based on the KDF_GOSTR3411_2012_256 function defined in
    \[[RFC7836](#RFC7836){.xref}\]:[¶](#section-8.1-4.4.1){.pilcrow}
    ...
    [¶](#section-8.1-4.4.2){.pilcrow}
    :::
    :::

::: {#TreeParam}
::: {#section-8.1.1 .section}
#### [8.1.1.](#section-8.1.1){.section-number .selfRef} [Key Tree Parameters](#name-key-tree-parameters){.section-name .selfRef} {#name-key-tree-parameters}

The CTR_OMAC cipher suites use the TLSTREE function for the rekeying
approach. The constants for it are defined as in the table
below.[¶](#section-8.1.1-1){.pilcrow}

+-----------------------------------+-----------------------------------+
| Cipher Suites                     | C_1, C_2, C_3                     |
+===================================+===================================+
| TLS_GOSTR34                       | -   [C_1=0xFFFFFFFF00000000[¶](   |
| 1112_256_WITH_KUZNYECHIK_CTR_OMAC | #section-8.1.1-2.2.1.2.1.1){.pilc |
|                                   | row}]{#section-8.1.1-2.2.1.2.1.1} |
|                                   | -   [C_2=0xFFFFFFFFFFF80000[¶](   |
|                                   | #section-8.1.1-2.2.1.2.1.2){.pilc |
|                                   | row}]{#section-8.1.1-2.2.1.2.1.2} |
|                                   | -   [C_3=0xFFFFFFFFFFFFFFC0[¶](   |
|                                   | #section-8.1.1-2.2.1.2.1.3){.pilc |
|                                   | row}]{#section-8.1.1-2.2.1.2.1.3} |
+-----------------------------------+-----------------------------------+
| TLS_GO                            | -   [C_1=0xFFFFFFC000000000[¶](   |
| STR341112_256_WITH_MAGMA_CTR_OMAC | #section-8.1.1-2.2.2.2.1.1){.pilc |
|                                   | row}]{#section-8.1.1-2.2.2.2.1.1} |
|                                   | -   [C_2=0xFFFFFFFFFE000000[¶](   |
|                                   | #section-8.1.1-2.2.2.2.1.2){.pilc |
|                                   | row}]{#section-8.1.1-2.2.2.2.1.2} |
|                                   | -   [C_3=0xFFFFFFFFFFFFF000[¶](   |
|                                   | #section-8.1.1-2.2.2.2.1.3){.pilc |
|                                   | row}]{#section-8.1.1-2.2.2.2.1.3} |
+-----------------------------------+-----------------------------------+
...
::: {#KEXP}
::: {#section-8.2 .section}
### [8.2.](#section-8.2){.section-number .selfRef} [Key Export and Key Import Algorithms](#name-key-export-and-key-import-a){.section-name .selfRef} {#name-key-export-and-key-import-a}

::: {#KExpImp15}
::: {#section-8.2.1 .section}
#### [8.2.1.](#section-8.2.1){.section-number .selfRef} [KExp15 and KImp15 Algorithms](#name-kexp15-and-kimp15-algorithm){.section-name .selfRef} {#name-kexp15-and-kimp15-algorithm}

Algorithms KExp15 and KImp15 use the block cipher determined by the
particular cipher suite.[¶](#section-8.2.1-1){.pilcrow}

The KExp15 key export algorithm is defined as
follows:[¶](#section-8.2.1-2){.pilcrow}
...
[¶](#section-8.2.1-3){.pilcrow}
:::

where the OMAC function is defined in \[[MODES](#MODES){.xref}\] and the
CTR-Encrypt(K, IV, S) function denotes the encryption of message S on
key K and nonce IV in the CTR mode with s = n (see
\[[MODES](#MODES){.xref}\]).[¶](#section-8.2.1-4){.pilcrow}

The KImp15 key import algorithm is defined as
follows:[¶](#section-8.2.1-5){.pilcrow}
...
[¶](#section-8.2.1-6){.pilcrow}
:::

where the OMAC function is defined in \[[MODES](#MODES){.xref}\] and the
CTR-Decrypt(K, IV, S) function denotes the decryption of message S on
key K and nonce IV in the CTR mode (see
\[[MODES](#MODES){.xref}\]).[¶](#section-8.2.1-7){.pilcrow}

The keys K_Exp_MAC and K_Exp_ENC [MUST]{.bcp14} be independent. For
every pair of keys (K_Exp_ENC, K_Exp_MAC), the IV values [MUST]{.bcp14}
be unique. For the import of a key with the KImp15 algorithm, the IV
value may be sent with the export key
representation.[¶](#section-8.2.1-8){.pilcrow}
:::
:::

::: {#KExpImp28147}
::: {#section-8.2.2 .section}
#### [8.2.2.](#section-8.2.2){.section-number .selfRef} [KExp28147 and KImp28147 Algorithms](#name-kexp28147-and-kimp28147-alg){.section-name .selfRef} {#name-kexp28147-and-kimp28147-alg}

The KExp28147 key export algorithm is defined as
follows:[¶](#section-8.2.2-1){.pilcrow}
...
[¶](#section-8.2.2-2){.pilcrow}
:::

where the gost28147IMIT function is defined in [Section
8.4](#IMIT){.xref} and the ECB-Encrypt(K, S) function denotes the
encryption of message S on key K with the block cipher GOST 28147-89 in
the electronic codebook (ECB) mode (see
\[[RFC5830](#RFC5830){.xref}\]).[¶](#section-8.2.2-3){.pilcrow}

The KImp28147 key import algorithm is defined as
follows:[¶](#section-8.2.2-4){.pilcrow}
...
[¶](#section-8.2.2-5){.pilcrow}
:::

where the gost28147IMIT function is defined in [Section
8.4](#IMIT){.xref} and the ECB-Decrypt(CEK_ENC, M) function denotes the
decryption of ciphertext CEK_ENC on key K with a block cipher GOST
28147-89 in the ECB mode (see
\[[RFC5830](#RFC5830){.xref}\]).[¶](#section-8.2.2-6){.pilcrow}
:::
:::
:::
:::
...
::: {#KEGAlgs}
::: {#section-8.3 .section}
### [8.3.](#section-8.3){.section-number .selfRef} [Key Exchange Generation Algorithms](#name-key-exchange-generation-alg){.section-name .selfRef} {#name-key-exchange-generation-alg}

::: {#KEG}
::: {#section-8.3.1 .section}
#### [8.3.1.](#section-8.3.1){.section-number .selfRef} [KEG Algorithm](#name-keg-algorithm){.section-name .selfRef} {#name-keg-algorithm}

The KEG algorithm is defined as follows:[¶](#section-8.3.1-1){.pilcrow}
...
where q is an order of a cyclic subgroup of elliptic curve points group
containing point Q, d in {1, \... , q -
1}.[¶](#section-8.3.1-3){.pilcrow}

The KEG_256 algorithm is defined as
follows:[¶](#section-8.3.1-4){.pilcrow}
...
[¶](#section-8.3.1-5){.pilcrow}
:::

where VKO_256 is the function VKO_GOSTR3410_2012_256 defined in
\[[RFC7836](#RFC7836){.xref}\] and KDFTREE_256 is the
KDF_TREE_GOSTR3411_2012_256 function defined in
\[[RFC7836](#RFC7836){.xref}\] with the parameter L equal to
512.[¶](#section-8.3.1-6){.pilcrow}

The KEG_512 algorithm is defined as
follows:[¶](#section-8.3.1-7){.pilcrow}
...
[¶](#section-8.3.1-8){.pilcrow}
:::

where VKO_512 is the VKO_GOSTR3410_2012_512 function defined in
\[[RFC7836](#RFC7836){.xref}\].[¶](#section-8.3.1-9){.pilcrow}
:::
:::

::: {#KEG_28147}
::: {#section-8.3.2 .section}
#### [8.3.2.](#section-8.3.2){.section-number .selfRef} [KEG_28147 Algorithm](#name-keg_28147-algorithm){.section-name .selfRef} {#name-keg_28147-algorithm}

The KEG_28147 algorithm is defined as
follows:[¶](#section-8.3.2-1){.pilcrow}
...
[¶](#section-8.3.2-2){.pilcrow}
:::

where the VKO_256 function is equal to the VKO_GOSTR3410_2012_256
function defined in \[[RFC7836](#RFC7836){.xref}\] and the CPDivers
function corresponds to the CryptoPro KEK Diversification Algorithm
defined in \[[RFC4357](#RFC4357){.xref}\], which takes as input the User
Keying Material (UKM) value and the key
value.[¶](#section-8.3.2-3){.pilcrow}
:::
:::
:::
:::
...
::: {#IMIT}
::: {#section-8.4 .section}
### [8.4.](#section-8.4){.section-number .selfRef} [gostIMIT28147](#name-gostimit28147){.section-name .selfRef} {#name-gostimit28147}

gost28147IMIT(IV, K, M) is a MAC algorithm with a 4-byte output and is
defined as follows:[¶](#section-8.4-1){.pilcrow}
...
where the PAD function is the padding function that adds m zero bytes to
the end of the message, m is the smallest, non-negative solution to the
equation (L(M) + m) mod 8 = 0, and the MAC28147 function corresponds to
the MAC generation mode defined in \[[RFC5830](#RFC5830){.xref}\] with a
4-byte length output.[¶](#section-8.4-3){.pilcrow}
:::
:::
:::
:::
...
registry:[¶](#section-9-1){.pilcrow}
  ...
  ----------- ------------------------------------------------ --------- ------------- -----------
  0xC1,0x00   TLS_GOSTR341112_256\_​WITH_KUZNYECHIK_CTR_OMAC   N         N             RFC 9189
  0xC1,0x01   TLS_GOSTR341112_256\_​WITH_MAGMA_CTR_OMAC        N         N             RFC 9189
  0xC1,0x02   TLS_GOSTR341112_256\_​WITH_28147_CNT_IMIT        N         N             RFC 9189

  : [Table 4](#table-4){.selfRef}

IANA has added the following values to the \"TLS SignatureAlgorithm\"
registry:[¶](#section-9-3){.pilcrow}
...
\"TLS SignatureAlgorithm\" registry:[¶](#section-9-7){.pilcrow}
...
> that went undetected for a long time. Additional allocations from the
> Reserved state are not expected, and the TLS SignatureScheme registry
> is suitable for use for new allocations instead of this
> registry.[¶](#section-9-8){.pilcrow}

IANA has added the following values to the \"TLS Supported Groups\"
registry:[¶](#section-9-9){.pilcrow}
...
Identifiers\" registry:[¶](#section-9-11){.pilcrow}
...
::: {#Historical}
::: {#section-10 .section}
## [10.](#section-10){.section-number .selfRef} [Historical Considerations](#name-historical-considerations){.section-name .selfRef} {#name-historical-considerations}

Note that prior to the existence of this document, implementations could
use only the values from the \"Private Use\" space in order to use the
GOST-based algorithms. So some old implementations can still use the old
value {0xFF, 0x85} instead of the {0xC1, 0x02} value to indicate the
TLS_GOSTR341112_256_WITH_28147_CNT_IMIT cipher suite; the old value 0xEE
instead of the values 64, 8, and 67 (to indicate the gostr34102012_256
signature algorithm, the Intrinsic hash algorithm, and the gost_sign256
certificate type, respectively); the old value 0xEF instead of the
values 65, 8, and 68 (to indicate the gostr34102012_512 signature
algorithm, the Intrinsic hash algorithm, and the gost_sign512
certificate type, respectively).[¶](#section-10-1){.pilcrow}

Due to historical reasons, in addition to the curve identifier values
listed in [Table 2](#tab-2){.xref}, there exist some extra identifier
values that correspond to the curves GC256B, GC256C, and GC256D as
follows (see \[[RFC4357](#RFC4357){.xref}\] and
\[[R-1323565.1.024-2019](#R-1323565.1.024-2019){.xref}\]).[¶](#section-10-2){.pilcrow}

+-----------------------------------+-----------------------------------+
| Description                       | Curve Identifier Values           |
+===================================+===================================+
| GC256B                            | -   [id-Gos                       |
|                                   | tR3410_2001-CryptoPro-XchA-ParamS |
|                                   | et[¶](#section-10-3.2.1.2.1.1){.p |
|                                   | ilcrow}]{#section-10-3.2.1.2.1.1} |
|                                   | -   [i                            |
|                                   | d-tc26-gost-3410-2012-256-paramSe |
|                                   | tB[¶](#section-10-3.2.1.2.1.2){.p |
|                                   | ilcrow}]{#section-10-3.2.1.2.1.2} |
+-----------------------------------+-----------------------------------+
| GC256C                            | id-                               |
|                                   | tc26-gost-3410-2012-256-paramSetC |
+-----------------------------------+-----------------------------------+
| GC256D                            | -   [id-Gos                       |
|                                   | tR3410-2001-CryptoPro-XchB-ParamS |
|                                   | et[¶](#section-10-3.2.3.2.1.1){.p |
|                                   | ilcrow}]{#section-10-3.2.3.2.1.1} |
|                                   | -   [i                            |
|                                   | d-tc26-gost-3410-2012-256-paramSe |
|                                   | tD[¶](#section-10-3.2.3.2.1.2){.p |
|                                   | ilcrow}]{#section-10-3.2.3.2.1.2} |
+-----------------------------------+-----------------------------------+

: [Table 9](#table-9){.selfRef}

The client should be prepared to handle any of these correctly if the
corresponding group is included in the supported_groups extension (see
\[[RFC8422](#RFC8422){.xref}\] and
\[[RFC7919](#RFC7919){.xref}\]).[¶](#section-10-4){.pilcrow}
:::
:::
...
Forward Secrecy.[¶](#section-11-1){.pilcrow}

The authenticate-then-encrypt method is crucial for the CNT_IMIT cipher
suite. Encryption of the MAC value is conducted to reduce the
possibility of forgery to guessing. Here, the probability of a guess is
approximately equal to 2^-32^, which is acceptable in some practical
cases.[¶](#section-11-2){.pilcrow}
:::
:::
...
\[RFC4490\]
:   [Leontiev, S., Ed.]{.refAuthor} and [G. Chudov, Ed.]{.refAuthor},
    ...
    (CMS)\"]{.refTitle}, [RFC 4490]{.seriesInfo}, [DOI
    10.17487/RFC4490]{.seriesInfo}, May 2006,
...
\[RFC5746\]
:   [Rescorla, E.]{.refAuthor}, [Ray, M.]{.refAuthor},
    [Dispensa, S.]{.refAuthor}, and [N. Oskov]{.refAuthor}, [\"Transport
    Layer Security (TLS) Renegotiation Indication
    Extension\"]{.refTitle}, [RFC 5746]{.seriesInfo}, [DOI
    10.17487/RFC5746]{.seriesInfo}, February 2010,
...
:   [Dworkin, M.]{.refAuthor}, [\"Recommendation for Block Cipher Modes
    of Operation: The CMAC Mode for Authentication\"]{.refTitle}, [NIST
    Special Publication 800-38B]{.seriesInfo}, [DOI
    10.6028/NIST.SP.800-38B]{.seriesInfo}, October 2016,
    \<<https://www.nist.gov/publications/recommendation-block-cipher-modes-operation-cmac-mode-authentication-0>\>.
:   

\[DraftGostTLS13\]
:   [Smyshlyaev, S.]{.refAuthor}, [Alekseev, E.]{.refAuthor},
    [Griboedova, E.]{.refAuthor}, [Babueva, A.]{.refAuthor}, and [L.
    Nikiforova]{.refAuthor}, [\"GOST Cipher Suites for Transport Layer
    Security (TLS) Protocol Version 1.3\"]{.refTitle}, [Work in
    Progress]{.refContent}, [Internet-Draft,
    draft-smyshlyaev-tls13-gost-suites-05]{.seriesInfo}, 10 December
    2021,
    \<<https://datatracker.ietf.org/doc/html/draft-smyshlyaev-tls13-gost-suites-05>\>.
:   

\[GOST3413-2015\]
:   [Federal Agency on Technical Regulating and Metrology]{.refAuthor},
    [\"Information technology. Cryptographic data security. Modes of
    operation for block ciphers\"]{.refTitle}, [GOST R
    34.13-2015]{.seriesInfo}, 2015.
:   

\[IK2003\]
:   [Iwata, T.]{.refAuthor} and [K. Kurosawa]{.refAuthor}, [\"OMAC:
    One-Key CBC MAC\"]{.refTitle}, [FSE 2003]{.refContent}, [Lecture
    Notes in Computer Science, Vol. 2887]{.refContent}, [DOI
    10.1007/978-3-540-39887-5_11]{.seriesInfo}, 2003,
    \<<https://doi.org/10.1007/978-3-540-39887-5_11>\>.
:   

\[MODES\]
:   [Dworkin, M.]{.refAuthor}, [\"Recommendation for Block Cipher Modes
    of Operation: Methods and Techniques\"]{.refTitle}, [NIST Special
    Publication 800-38A]{.seriesInfo}, [DOI
    10.6028/NIST.SP.800-38A]{.seriesInfo}, December 2001,
    \<<https://csrc.nist.gov/publications/detail/sp/800-38a/final>\>.
:   

\[R-1323565.1.024-2019\]
:   [Federal Agency on Technical Regulating and Metrology]{.refAuthor},
    [\"Information technology. Cryptographic data security. Elliptic
    curve parameters for the cryptographic algorithms and
    protocols\"]{.refTitle}, [R 1323565.1.024-2019]{.seriesInfo},
    January 2019.
:   
...
:   [Rescorla, E.]{.refAuthor}, [\"The Transport Layer Security (TLS)
    ...
    [Internet-Draft, draft-ietf-tls-rfc8446bis-04]{.seriesInfo}, 7 March
    2022,
...
::: {#Appendix}
::: {#appendix-A .section}
## [Appendix A.](#appendix-A){.section-number .selfRef} [Test Examples](#name-test-examples){.section-name .selfRef} {#name-test-examples}

::: {#appendix-A.1 .section}
### [A.1.](#appendix-A.1){.section-number .selfRef} [Test Examples for CTR_OMAC Cipher Suites](#name-test-examples-for-ctr_omac-){.section-name .selfRef} {#name-test-examples-for-ctr_omac-}

::: {#appendix-A.1.1 .section}
#### [A.1.1.](#appendix-A.1.1){.section-number .selfRef} [TLSTREE Examples](#name-tlstree-examples){.section-name .selfRef} {#name-tlstree-examples}

::: {#appendix-A.1.1.1 .section}
##### [A.1.1.1.](#appendix-A.1.1.1){.section-number .selfRef} [TLS_GOSTR341112_256_WITH_MAGMA_CTR_OMAC Cipher Suite](#name-tls_gostr341112_256_with_ma){.section-name .selfRef} {#name-tls_gostr341112_256_with_ma}
...
##### [A.1.1.2.](#appendix-A.1.1.2){.section-number .selfRef} [TLS_GOSTR341112_256_WITH_KUZNYECHIK_CTR_OMAC Cipher Suite](#name-tls_gostr341112_256_with_ku){.section-name .selfRef} {#name-tls_gostr341112_256_with_ku}
...
#### [A.1.2.](#appendix-A.1.2){.section-number .selfRef} [Record Examples](#name-record-examples){.section-name .selfRef} {#name-record-examples}

::: {#appendix-A.1.2.1 .section}
##### [A.1.2.1.](#appendix-A.1.2.1){.section-number .selfRef} [TLS_GOSTR341112_256_WITH_MAGMA_CTR_OMAC Cipher Suite](#name-tls_gostr341112_256_with_mag){.section-name .selfRef} {#name-tls_gostr341112_256_with_mag}
...
##### [A.1.2.2.](#appendix-A.1.2.2){.section-number .selfRef} [TLS_GOSTR341112_256_WITH_KUZNYECHIK_CTR_OMAC Cipher Suite](#name-tls_gostr341112_256_with_kuz){.section-name .selfRef} {#name-tls_gostr341112_256_with_kuz}
...
#### [A.1.3.](#appendix-A.1.3){.section-number .selfRef} [Handshake Examples](#name-handshake-examples){.section-name .selfRef} {#name-handshake-examples}

The ClientHello.extensions and the ServerHello.extensions fields contain
the extended_main_secret extension (see \[[RFC7627](#RFC7627){.xref}\])
and the renegotiation_info extension (see
\[[RFC5746](#RFC5746){.xref}\]) in the following
examples.[¶](#appendix-A.1.3-1){.pilcrow}

::: {#appendix-A.1.3.1 .section}
##### [A.1.3.1.](#appendix-A.1.3.1){.section-number .selfRef} [TLS_GOSTR341112_256_WITH_MAGMA_CTR_OMAC Cipher Suite](#name-tls_gostr341112_256_with_magm){.section-name .selfRef} {#name-tls_gostr341112_256_with_magm}
...
##### [A.1.3.2.](#appendix-A.1.3.2){.section-number .selfRef} [TLS_GOSTR341112_256_WITH_KUZNYECHIK_CTR_OMAC Cipher Suite](#name-tls_gostr341112_256_with_kuzn){.section-name .selfRef} {#name-tls_gostr341112_256_with_kuzn}
...
### [A.2.](#appendix-A.2){.section-number .selfRef} [Test Examples for CNT_IMIT Cipher Suites](#name-test-examples-for-cnt_imit-){.section-name .selfRef} {#name-test-examples-for-cnt_imit-}

::: {#appendix-A.2.1 .section}
#### [A.2.1.](#appendix-A.2.1){.section-number .selfRef} [Record Examples](#name-record-examples-2){.section-name .selfRef} {#name-record-examples-2}
...
#### [A.2.2.](#appendix-A.2.2){.section-number .selfRef} [Handshake Examples](#name-handshake-examples-2){.section-name .selfRef} {#name-handshake-examples-2}

The ClientHello.extensions and the ServerHello.extensions fields contain
the renegotiation_info extension (see \[[RFC5746](#RFC5746){.xref}\]) in
the following examples.[¶](#appendix-A.2.2-1){.pilcrow}
...
::: {.left dir="auto"}
[Dmitry Eremin-Solenikov]{.fn .nameRole}
:::
...
::: {.left dir="auto"}
[14/2, Kedrova St.]{.street-address}
:::
