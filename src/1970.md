...
Narten, Nordmark & Simpson  Standards Track                    [Page 11]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 12]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 13]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 14]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 15]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 28]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 29]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 30]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 31]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 32]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 33]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 34]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 35]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 36]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 37]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 38]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 39]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 40]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 41]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 42]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 43]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 44]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 45]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 46]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 47]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 48]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 49]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 50]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 51]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 52]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 53]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 54]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 55]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 56]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 57]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 58]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 59]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 60]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 61]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 62]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 63]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 64]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 65]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 66]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 67]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 68]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 69]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 70]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 71]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 72]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 73]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 74]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 75]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 76]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 77]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 78]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 79]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 80]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 81]
```
...
Narten, Nordmark & Simpson  Standards Track                    [Page 82]
```
