...
Komu & Henderson              Experimental                      [Page 2]
```
...
Komu & Henderson              Experimental                      [Page 3]
```
...
Komu & Henderson              Experimental                      [Page 4]
```
...
Komu & Henderson              Experimental                      [Page 5]
```
...
RFC 6317              Basic API Extensions for HIP             July 2011
   ...
   address structures to the application.  Finally, the application
...
Komu & Henderson              Experimental                      [Page 6]
```
...
Komu & Henderson              Experimental                      [Page 7]
```
...
Komu & Henderson              Experimental                      [Page 8]
```
...
Komu & Henderson              Experimental                      [Page 9]
```
...
Komu & Henderson              Experimental                     [Page 10]
```
...
RFC 6317              Basic API Extensions for HIP             July 2011
   ...
   "automated" resolver extensions for the getaddrinfo() resolver
...
Komu & Henderson              Experimental                     [Page 11]
```
...
Komu & Henderson              Experimental                     [Page 12]
```
...
Komu & Henderson              Experimental                     [Page 13]
```
...
Komu & Henderson              Experimental                     [Page 14]
```
...
Komu & Henderson              Experimental                     [Page 15]
```
...
Komu & Henderson              Experimental                     [Page 16]
```
...
Komu & Henderson              Experimental                     [Page 17]
```
...
Komu & Henderson              Experimental                     [Page 18]
```
