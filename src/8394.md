...
RFC 8394          Split-NVE Control-Plane Requirements          May 2018
   ...
   events and behaviors on the hypervisor-facing side.  Some of the
...
RFC 8394          Split-NVE Control-Plane Requirements          May 2018
   ...
   the multicast router.  The multicast router can then correctly route
...
Li, et al.                    Informational                    [Page 24]
```
...
Li, et al.                    Informational                    [Page 25]
```
...
Li, et al.                    Informational                    [Page 26]
```
