...
Selander, et al.             Standards Track                    [Page 3]
```
...
Selander, et al.             Standards Track                    [Page 4]
```
...
Selander, et al.             Standards Track                    [Page 5]
```
...
Selander, et al.             Standards Track                    [Page 6]
```
...
Selander, et al.             Standards Track                    [Page 7]
```
...
Selander, et al.             Standards Track                    [Page 8]
```
...
Selander, et al.             Standards Track                    [Page 9]
```
...
Selander, et al.             Standards Track                   [Page 10]
```
...
Selander, et al.             Standards Track                   [Page 11]
```
...
Selander, et al.             Standards Track                   [Page 12]
```
...
Selander, et al.             Standards Track                   [Page 13]
```
...
Selander, et al.             Standards Track                   [Page 14]
```
...
Selander, et al.             Standards Track                   [Page 15]
```
...
Selander, et al.             Standards Track                   [Page 16]
```
...
Selander, et al.             Standards Track                   [Page 17]
```
...
Selander, et al.             Standards Track                   [Page 18]
```
...
Selander, et al.             Standards Track                   [Page 19]
```
...
Selander, et al.             Standards Track                   [Page 20]
```
...
Selander, et al.             Standards Track                   [Page 21]
```
...
Selander, et al.             Standards Track                   [Page 22]
```
...
Selander, et al.             Standards Track                   [Page 23]
```
...
Selander, et al.             Standards Track                   [Page 24]
```
...
Selander, et al.             Standards Track                   [Page 25]
```
...
Selander, et al.             Standards Track                   [Page 26]
```
...
RFC 8613                         OSCORE                        July 2019
         ...
         This parameter SHALL be present in requests and will not
...
Selander, et al.             Standards Track                   [Page 27]
```
...
RFC 8613                         OSCORE                        July 2019
   ...
   While the 'kid' parameter is used to transport the Sender ID, the new
...
Selander, et al.             Standards Track                   [Page 28]
```
...
RFC 8613                         OSCORE                        July 2019
   ...
   properties, see Section 7.4 and Appendix D.4.  Another non-Observe
...
Selander, et al.             Standards Track                   [Page 29]
```
...
Selander, et al.             Standards Track                   [Page 30]
```
...
Selander, et al.             Standards Track                   [Page 31]
```
...
Selander, et al.             Standards Track                   [Page 32]
```
...
Selander, et al.             Standards Track                   [Page 33]
```
...
Selander, et al.             Standards Track                   [Page 34]
```
...
Selander, et al.             Standards Track                   [Page 35]
```
...
Selander, et al.             Standards Track                   [Page 36]
```
...
Selander, et al.             Standards Track                   [Page 37]
```
...
Selander, et al.             Standards Track                   [Page 38]
```
...
Selander, et al.             Standards Track                   [Page 39]
```
...
Selander, et al.             Standards Track                   [Page 40]
```
...
Selander, et al.             Standards Track                   [Page 41]
```
...
Selander, et al.             Standards Track                   [Page 42]
```
...
Selander, et al.             Standards Track                   [Page 43]
```
...
Selander, et al.             Standards Track                   [Page 44]
```
...
Selander, et al.             Standards Track                   [Page 45]
```
...
Selander, et al.             Standards Track                   [Page 46]
```
...
Selander, et al.             Standards Track                   [Page 47]
```
...
Selander, et al.             Standards Track                   [Page 48]
```
...
Selander, et al.             Standards Track                   [Page 49]
```
...
Selander, et al.             Standards Track                   [Page 50]
```
...
Selander, et al.             Standards Track                   [Page 51]
```
...
Selander, et al.             Standards Track                   [Page 52]
```
...
Selander, et al.             Standards Track                   [Page 53]
```
...
Selander, et al.             Standards Track                   [Page 56]
```
...
Selander, et al.             Standards Track                   [Page 64]
```
...
Selander, et al.             Standards Track                   [Page 65]
```
...
Selander, et al.             Standards Track                   [Page 66]
```
...
Selander, et al.             Standards Track                   [Page 67]
```
...
Selander, et al.             Standards Track                   [Page 68]
```
...
Selander, et al.             Standards Track                   [Page 69]
```
...
Selander, et al.             Standards Track                   [Page 70]
```
...
Selander, et al.             Standards Track                   [Page 71]
```
...
Selander, et al.             Standards Track                   [Page 72]
```
...
Selander, et al.             Standards Track                   [Page 73]
```
...
Selander, et al.             Standards Track                   [Page 74]
```
...
Selander, et al.             Standards Track                   [Page 75]
```
...
Selander, et al.             Standards Track                   [Page 76]
```
...
Selander, et al.             Standards Track                   [Page 77]
```
...
Selander, et al.             Standards Track                   [Page 78]
```
...
Selander, et al.             Standards Track                   [Page 79]
```
...
Selander, et al.             Standards Track                   [Page 80]
```
...
Selander, et al.             Standards Track                   [Page 81]
```
...
Selander, et al.             Standards Track                   [Page 82]
```
...
Selander, et al.             Standards Track                   [Page 83]
```
...
Selander, et al.             Standards Track                   [Page 84]
```
...
Selander, et al.             Standards Track                   [Page 85]
```
...
Selander, et al.             Standards Track                   [Page 86]
```
...
Selander, et al.             Standards Track                   [Page 87]
```
...
RFC 8613                         OSCORE                        July 2019
   ...
   OSCORE depends on a preestablished random Master Secret
...
Selander, et al.             Standards Track                   [Page 88]
```
...
Selander, et al.             Standards Track                   [Page 89]
```
...
Selander, et al.             Standards Track                   [Page 90]
```
...
Selander, et al.             Standards Track                   [Page 91]
```
...
Selander, et al.             Standards Track                   [Page 92]
```
...
Selander, et al.             Standards Track                   [Page 93]
```
...
Selander, et al.             Standards Track                   [Page 94]
```
